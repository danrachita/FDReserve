...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000004fb7baee7776a84adb73de8068913e95dd60f5d0e99c991f5605e25297b"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1533275628, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nTargetSpacingSlowLaunch = 1 * 60;  // FDReserve: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // FDReserve: 60 Seconds
        nMaturity = 20;
        ...
        const char* pszTimestamp = "The only true wisdom is in knowing you know nothing";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1533275628;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2021393;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000004fb7baee7776a84adb73de8068913e95dd60f5d0e99c991f5605e25297b"));
        assert(genesis.hashMerkleRoot == uint256("0x9f57253228924d0245c9007136c2c8b121eca51431c6fbec43569acbfdf54442"));

        vSeeds.push_back(CDNSSeedData("51.68.44.138", "51.68.44.138"));
        vSeeds.push_back(CDNSSeedData("51.255.49.93", "51.255.49.93"));
        vSeeds.push_back(CDNSSeedData("164.132.195.229", "164.132.195.229"));
        vSeeds.push_back(CDNSSeedData("54.37.65.7", "54.37.65.7"));
        vSeeds.push_back(CDNSSeedData("54.37.65.139", "54.37.65.139"));
        ...
        strSporkKey = "04d29cf787eee4de03bdc3037448ae84aad37790b4f8b4ce45f305bcfa5a14291b5a5622852f7478fc2fd0cf4014672289291da37984e92a0a82ed64d86ad29870";
        strObfuscationPoolDummyAddress = "fdJAo1A7gPBftYSHywtBN7XRfHTWWQeJm4";
        nStartMasternodePayments = 1533275628;
