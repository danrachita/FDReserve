...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("FDReserve Core"),
     ...
     * override -datadir in the fdreserve.conf file in the default data directory
     * (to be consistent with fdreserved behavior)
     */
    if (dataDir != getDefaultDataDirectory())
